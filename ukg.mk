...
# device
$(call inherit-product-if-exists, device/asus/grouper/full_tenderloin.mk)
...
PRODUCT_BRAND := HP
PRODUCT_NAME := ukg_tenderloin
PRODUCT_MODEL := touchpad
PRODUCT_MANUFACTURER := HP
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.tenderloin.$(shell date +%m%d%y).$(shell date +%H%M%S)
# overrides
